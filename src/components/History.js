...
const History = (props) => {
    ...
    if (props.history) {
            if(showEdit) {
                return (<EditHistory id={props.history._id} company={props.history.company} desc={props.history.description} role={props.history.role} start={props.history.start} stop={props.history.stop} callback={displayEdit} />);
            }
